defmodule Erlmastery.PromEx do
  @moduledoc """
  ...
  def dashboard_assigns do
    [
      datasource_id: "Erlmastery_prometheus",
  ...
  def dashboards do
    [
      ...
      # {:erlmastery, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
